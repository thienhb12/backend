...
<form class="form-horizontal" method="post" action="index.php?mod={$smarty.get.mod}&amod={$smarty.get.amod}&atask={$smarty.get.atask}&task={$smarty.get.task}&filter_title={$smarty.get.filter_title}&per_page={$smarty.get.per_page}&page={$smarty.get.page}&sys={$smarty.get.sys}" role="form" data-toggle="validator">
   <div class="form-group">
	 <div class="col-sm-offset-2 col-sm-10">
		<div class="{$style}"><b>{$message}</b></div>
	</div>
   <div class="form-group">
