...
<div style=" font-size:13px; text-transform:uppercase; font-weight:bold; color:#006600" align="center">{#poll_title#}</div><br /><br />
<div align="center">
	<div style="width:550px; text-align:left;"><b>Tổng số bình chọn : {$pollQuestion.total_poll|default:0}</b></div>
</div>
