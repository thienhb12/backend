...
(function()
{
	var imageDialog = function( editor, dialogType )
	{
		...
		get_image_list = function(page) {
			...
			var url = '/index.php?mod=admin&amod=article&atask=images&task=list&ajax&page='+page;
			...
			contents : [
				...
				},
				{
					...
					[
						{
							type : 'html',
							html: '<form id="frmUpload" name="frmUpload" method="post" target="UploadWindow" enctype="multipart/form-data" action="/index.php?mod=admin&amod=article&atask=images&task=upload&ajax">' +
